...
export function BrandCard({ brand, index }: BrandCardProps) {
  return (
    <motion.div
      ...
      className="group bg-white p-10 border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] hover:border-primary/30 transition-all duration-500 rounded-[2rem] flex flex-col items-center text-center relative overflow-hidden"
    >
      ...
      <p className="text-gray-500 text-sm leading-relaxed line-clamp-3 group-hover:text-gray-700 transition-colors">
        {brand.description}
      </p>
      ...
      <motion.div 
        ...
        className="mt-6 text-primary text-xs font-bold uppercase tracking-widest flex items-center gap-2 cursor-pointer"
      >
